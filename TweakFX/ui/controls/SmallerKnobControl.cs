...
namespace dfsa.ui.controls
{
    ...
    class SmallerKnobControl : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (GraphicsPath path = new())
            {
                ...
                using (LinearGradientBrush fillBrush = new(rect, Color.FromArgb(0, 0, 0), Color.FromArgb(0, 0, 0), LinearGradientMode.BackwardDiagonal))
                {
                    ...
                    colorBlend.Colors = [Color.FromArgb(2, 135, 146), Color.FromArgb(2, 196, 205), Color.FromArgb(1, 8, 8)];
                    colorBlend.Positions = [0f, 0.3f, 1f];
        ...
        private void DrawExternalMarker(Graphics g, Rectangle rect, float angle, bool active)
        {
            ...
            using (Pen pen = new Pen(active ? Color.FromArgb(117, 226, 234) : Color.FromArgb(110, 110, 110), 2f))
            {
